...
const translations = {
  en: {
    ...
    "Bench press (Smith machine)": "Penkkipunnerrus (Smith)",
    "Cable crossover": "Ristikkäistalja",
    "Dip (Regular)": "Dippi (Normaali)",
    "Dip (Wide)": "Dippi (Leveä)",
    "Fly (Dumbbell)": "Fly (käsipainot)",
    ...
    // LEEEEGS
    "Calf (Sitting)": "Pohkeet (Istuen)",
    "Calf (Standing)": "Pohkeet (Seisten)",
    "Leg curl (Lying)": "Jalkojen koukistus (Maaten)",
    "Leg curl (Seated)": "Jalkojen koukistus (Istuen)",
    ...
    "Leg extension": "Jalkojen ojennus",
    ...
    "Overhead press (Dumbbell)": "Pystypunnerrus (Käsipainot)",
    ...
    "Bicep curl (Dumbbell)": "Hauiskääntö (Käsipainot)",
    "Dip (Narrow)": "Dippi (Kapea)",
    "Hammer (Dumbbell)": "Hammer (Käsipainot)",
